...
echo "<br>";
echo "Ano Edição:  " .$livros1->_AnoEd = "24 setembro 2012";
echo "<br>";
echo "Quantidade Página:  " .$livros1->_QtdPag = "408 páginas";
echo "<br>";
echo "Capa: <img width='100' height='100' src='" .$livros1->_Capa = "/aula_19_08_22/img/01.jpg'/>";
echo "<br>";
...
echo "<br>";
echo "Ano Edição:  " .$livros1->_AnoEd = "24 janeiro 2017";
echo "<br>";
echo "Quantidade Página:  " .$livros1->_QtdPag = "312 páginas";
echo "<br>";
echo "Capa: <img width='100' height='100' src='" .$livros1->_Capa = "/aula_19_08_22/img/02.jpg'/>";
echo "<br>";
...
echo "<br>";
echo "Ano Edição:  " .$livros1->_AnoEd = "30 novembro 2020";
echo "<br>";
echo "Quantidade Página:  " .$livros1->_QtdPag = "208 páginas";
echo "<br>";
echo "Capa: <img width='100' height='100' src='" .$livros1->_Capa = "/aula_19_08_22/img/03.jpg'/>";
echo "<br>";
...
echo "<br>";
echo "Ano Edição:  " .$livros1->_AnoEd = "4 agosto 2017";
echo "<br>";
echo "Quantidade Página:  " .$livros1->_QtdPag = "";
echo "<br>";
echo "Capa: <img width='100' height='100' src='" .$livros1->_Capa = "/aula_19_08_22/img/04.jpg'/>";
echo "<br>";
echo "Preço R$  " . $livros4->_Preco = number_format(22.50),2;
echo "<br>";
